                    ...
                    <div class="col-12 col-lg-8">
                        <div class="card" style="text-align-last: center">
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <img src="https://i.imgur.com/tPKodUd.png" width="252" height="252">
                                    <h1 class="mb-0" style="padding-top: 20px">Account Deactivated</h1>
                                    <p>Your account has been deactivated, <br>please contact admin for account activation.</p>
                                    <a href="javascript:void(Tawk_API.toggle())" class="btn btn-facebook btn-lg mb-3">Contact Admin</a>
                                </div>
                        </div>
                    </div>
                </div>
